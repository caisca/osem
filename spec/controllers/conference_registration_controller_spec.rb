  ...
  context 'user is signed in' do
    ...
    describe 'PATCH #update' do
      ...
      context 'updates successfully' do
        before do
          patch :update, params: { registration: attributes_for(:registration, arrival: Date.new(2014, 04, 29)), conference_id: conference.short_title }
        end
      ...
      context 'update fails' do
        before do
          ...
          patch :update, params: { registration: attributes_for(:registration, arrival: Date.new(2014, 04, 27)), conference_id: conference.short_title }
        end
